    ...
    <>
      <div className="container ">
        <div className="sidenav ">
          ...
          <Link style={{ textDecoration: "none", color: "white", display: "flex" }} to="/explore">
            <MdOutlineExplore className="icon" />
            <span>Explore</span>
          </Link>
          <Link style={{ textDecoration: "none", color: "white", display: "flex" }} to="/profile">
            <FaRegUserCircle className="icon" />
            <span>Profile</span>
          </Link>

          <img src="https://i.ibb.co/6sKqXGr/juicy-team-discussing-the-project.png" alt="juicy-team-discussing-the-project" border="0" className="img-diskusi" width={200} />
        </div>
              ...
              <>
                <div className="postingan-container">
                  <div className="profile-home">
                    <img src={post.author.title} className="photo-profile" />
        ...
        <div className="rightbar col-3">
          ...
          <img src="https://i.ibb.co/jG9BkB8/juicy-girl-sending-messages-from-her-phone.png" alt="juicy-girl-sending-messages-from-her-phone" border="0" className="img-diskusi2" width={200} />
        </div>
      </div>
